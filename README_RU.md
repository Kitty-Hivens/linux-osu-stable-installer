...
- **Зависимости:** `curl`, `unzip`, `winetricks`, `icoutils`, `gum` — устанавливаются автоматически на поддерживаемых системах.
