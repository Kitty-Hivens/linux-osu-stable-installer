...
> **Пользователям NixOS:** Рекомендуется использовать [нативный форк](https://github.com/afanetd/linux-osu-stable-installer-nixos) от **afanetd** для корректной работы.
